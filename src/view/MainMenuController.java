...
public class MainMenuController {
    ...
    @FXML
    void btnBathroomProblemPressed(ActionEvent event) {
        loadScene("BathroomProblem.fxml", event);
    }
    ...
    void btnProducerConsumerPressed(ActionEvent event) {
        loadScene("ProducerConsumer.fxml", event);
    }

    @FXML
    void btnReadersWritersPressed(ActionEvent event) {
        loadScene("ReadersWriters.fxml", event);
    }

    @FXML
    void btnSleepingBarberPressed(ActionEvent event) {
        loadScene("SleepingBarber.fxml", event);
    }
