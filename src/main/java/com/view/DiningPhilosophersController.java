...
import com.core.diningphilosopher.DiningPhilosophersMonitor;
import com.core.diningphilosopher.Philosopher;
import com.core.diningphilosopher.gui.PhilosopherStateListener;
...
public class DiningPhilosophersController implements PhilosopherStateListener {
    ...
    void btnBackPressed(ActionEvent event) {
        if(philosophers != null) btnStopPressed(event);
        try {
